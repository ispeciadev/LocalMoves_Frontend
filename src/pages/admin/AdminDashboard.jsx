...
// 🟣 Glassy Stat Card
function StatCard({ label, value, icon: Icon, highlight, isDarkMode }) {
  const numeric = Number(value ?? 0);

  return (
    <div
      className={`backdrop-blur-md border shadow-sm hover:shadow-md rounded-2xl p-4 md:p-5 flex items-center justify-between transition-all duration-200 ${
        isDarkMode
    ...
    >
      <div className="flex-1 min-w-0">
        <p
          className={`text-[11px] md:text-xs font-medium uppercase tracking-wide truncate transition-colors ${
        ...
        <p
          className={`mt-2 text-xl md:text-2xl lg:text-3xl font-semibold transition-colors truncate ${
      ...
      <div
        className={`h-10 w-10 md:h-12 md:w-12 rounded-2xl flex-shrink-0 flex items-center justify-center shadow-sm ml-3 ${
          highlight
...
function MetricCard({ title, value, badge, isDarkMode }) {
  ...
  return (
    <div
      className={`backdrop-blur-md border hover:shadow-md shadow-sm rounded-2xl p-4 md:p-5 transition-all duration-200 ${
        isDarkMode
    ...
    >
      <div className="flex items-center justify-between mb-2">
        ...
        {badge && (
          <span
            className={`inline-flex items-center rounded-full px-2 py-0.5 text-[10px] md:text-[11px] font-medium shadow-sm transition-colors flex-shrink-0 ml-2 ${
              isDarkMode
      ...
      <p
        className={`text-xl md:text-2xl lg:text-3xl font-semibold transition-colors truncate ${
          isDarkMode ? "text-slate-100" : "text-gray-800"
        }`}
      >
        ₹{numeric.toLocaleString("en-IN")}
...
function RangeTabs({ value, onChange, isDarkMode }) {
  return (
    <div
      className={`inline-flex rounded-full px-1.5 py-1 text-[10px] md:text-xs shadow-inner transition-colors w-full sm:w-auto ${
    ...
    >
      {[
        ...
        <button
          ...
          className={`px-2 md:px-3 py-1 rounded-full transition-all font-medium flex-1 sm:flex-none ${
            value === opt.key
...
function RevenueTooltip({ active, payload, label, isDarkMode }) {
  ...
  return (
    <div
      className={`rounded-xl border px-3 py-2 text-xs shadow-md transition-colors ${
        isDarkMode
    ...
    <div className="min-h-screen overflow-hidden">
      <div className="pt-2 space-y-4 md:space-y-6 pb-4 md:pb-6 px-3 md:px-6 max-w-[1920px] mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-3">
          <div className="flex-1 min-w-0">
            <h2
              className={`text-lg md:text-xl lg:text-2xl font-semibold transition-colors truncate ${
                isDarkMode ? "text-slate-100" : "text-gray-800"
              }`}
            >
              Admin Dashboard
            ...
            <p
              className={`text-xs md:text-sm transition-colors truncate ${
          ...
          <button
            ...
            className={`self-start md:self-auto px-3 md:px-4 py-1.5 md:py-2 rounded-full border text-xs md:text-sm hover:transition flex items-center gap-2 transition-colors flex-shrink-0 mt-2 md:mt-0 ${
              isDarkMode
        ...
        {loading && (
          <div className="w-full flex justify-center py-12 md:py-20">
            <div className="flex flex-col items-center gap-3">
              <div
                className={`h-8 w-8 border-2 border-t-transparent rounded-full animate-spin transition-colors ${
        ...
        {!loading && error && (
          <div
            className={`p-3 md:p-4 border rounded-2xl text-sm flex flex-col sm:flex-row sm:items-start justify-between gap-3 transition-colors ${
              isDarkMode
        ...
        {!loading && !error && (
          <>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 md:gap-6">
              {/* Revenue Chart */}
              <div
                className={`backdrop-blur-md border shadow-md rounded-2xl p-3 md:p-4 lg:p-5 flex flex-col gap-3 md:gap-4 transition-colors ${
                  isDarkMode
                    ? "bg-slate-800/90 border-slate-700"
                    : "bg-white/90 border-pink-200"
                }`}
              >
                ...
                <div
                  className={`mt-1 flex items-center justify-between text-[11px] md:text-xs border-t pt-2 md:pt-3 ${
                    isDarkMode
            ...
            <div
              className={`backdrop-blur-md border shadow-md rounded-2xl p-3 md:p-4 lg:p-6 mt-4 transition-colors ${
                isDarkMode
                  ? "bg-slate-800/90 border-slate-700"
                  : "bg-white/90 border-pink-200"
              }`}
            >
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-3 md:mb-4">
                <div className="flex-1 min-w-0">
                  <h3
                    className={`text-sm md:text-base font-semibold transition-colors truncate ${
                      isDarkMode ? "text-slate-100" : "text-gray-800"
                    }`}
                  >
                    Subscription Breakdown
                ...
                {totalSubscriptions > 0 && (
                  <span
                    className={`text-[11px] md:text-xs transition-colors mt-2 sm:mt-0 ${
                      isDarkMode ? "text-slate-400" : "text-gray-500"
                    }`}
                  >
                    Total:{" "}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4">
                {subscriptions.length === 0 && (
                  <p
                    className={`text-xs transition-colors col-span-full ${
                      isDarkMode ? "text-slate-500" : "text-gray-400"
                    }`}
                  >
                ...
                {subscriptions.map((sub) => {
                  ...
                  return (
                    <div
                      ...
                      className={`backdrop-blur border rounded-2xl p-3 md:p-4 shadow-sm hover:shadow-md transition-all ${
                        isDarkMode
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div className="flex-1 min-w-0">
                          ...
                          <p
                            className={`text-lg md:text-xl font-semibold transition-colors truncate ${
                              isDarkMode ? "text-slate-100" : "text-gray-900"
                            }`}
                          >
                            {count}
                        ...
                        <div
                          className={`h-8 w-8 md:h-10 md:w-10 rounded-xl flex-shrink-0 flex items-center justify-center font-bold text-sm ml-3 transition-colors ${
                            isDarkMode
                      ...
                      <div className="mt-2">
                        <div
                          className={`w-full h-1.5 rounded-full overflow-hidden transition-colors ${
                            isDarkMode ? "bg-slate-700" : "bg-pink-100"
                          }`}
                        >
                          <div
                        ...
                        <p
                          className={`text-[10px] mt-1 transition-colors truncate ${
                            isDarkMode ? "text-slate-400" : "text-gray-500"
                          }`}
                        >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6 mt-4 md:mt-6">
              {/* Recent Users */}
              <div
                className={`backdrop-blur-md border shadow-md rounded-2xl p-3 md:p-4 lg:p-5 transition-colors ${
                  isDarkMode
                    ? "bg-slate-800/90 border-slate-700"
                    : "bg-white/90 border-pink-200"
                }`}
              >
                ...
                <div
                  className={`overflow-x-auto scroll-thin-pink rounded-xl border transition-colors ${
                ...
                >
                  <table className="min-w-full text-xs md:text-sm">
                    ...
                    >
                      <tr>
                        <th className="py-2 px-2 md:px-3 text-left">Name</th>
                        <th className="py-2 px-2 md:px-3 text-left hidden sm:table-cell">
                          Email
                        </th>
                        <th className="py-2 px-2 md:px-3 text-left">Role</th>
                    ...
                    <tbody>
                      {(recent.users || []).slice(0, 10).map((u, idx) => (
                        ...
                        >
                          <td
                            className={`py-2 px-2 md:px-3 font-medium transition-colors truncate max-w-[100px] ${
                              isDarkMode ? "text-slate-100" : "text-gray-900"
                            }`}
                          >
                            {u.full_name || "-"}
                          ...
                          <td
                            className={`py-2 px-2 md:px-3 hidden sm:table-cell transition-colors truncate max-w-[120px] ${
                          ...
                          <td className="py-2 px-2 md:px-3">
                            <span
                              className={`inline-flex items-center rounded-full px-2 py-0.5 text-[10px] font-medium transition-colors truncate ${
                                isDarkMode
                                  ? "bg-pink-900/30 text-pink-300"
                                  : "bg-pink-100 text-pink-800"
                              }`}
                          ...
                          <td
                            className={`py-2 px-2 md:px-3 hidden md:table-cell transition-colors truncate ${
                              isDarkMode ? "text-slate-400" : "text-gray-500"
                            }`}
                          >
                      ...
                      {(recent.users || []).length === 0 && (
                        <tr>
                          <td
                            colSpan={4}
                            className={`py-4 px-3 text-center text-xs transition-colors ${
                              isDarkMode ? "text-slate-500" : "text-gray-400"
                            }`}
                          >
                            No recent users.
              ...
              >
                ...
                >
                  <table className="min-w-full text-xs md:text-sm">
                    ...
                    >
                      <tr>
                        <th className="py-2 px-2 md:px-3 text-left">Company</th>
                        <th className="py-2 px-2 md:px-3 text-left hidden sm:table-cell">
                          Manager
                        </th>
                        <th className="py-2 px-2 md:px-3 text-left">Plan</th>
                        <th className="py-2 px-2 md:px-3 text-left hidden md:table-cell">
                          Created
                        </th>
                      </tr>
              ...
              >
                ...
                >
                  <table className="min-w-full text-xs md:text-sm">
                    ...
                    >
                      <tr>
                        <th className="py-2 px-2 md:px-3 text-left">ID</th>
                        <th className="py-2 px-2 md:px-3 text-left hidden sm:table-cell">
                          Company
                        </th>
                        <th className="py-2 px-2 md:px-3 text-left">Amount</th>
                        <th className="py-2 px-2 md:px-3 text-left hidden sm:table-cell">
                          Plan
                        </th>
                        <th className="py-2 px-2 md:px-3 text-left">Status</th>
                      </tr>
                    </thead>
                    <tbody>
                      {(recent.payments || []).slice(0, 10).map((p, idx) => {
                        ...
                        return (
                          ...
                          >
                            <td
                              className={`py-2 px-2 md:px-3 font-medium transition-colors truncate max-w-[80px] ${
                                isDarkMode ? "text-slate-100" : "text-gray-900"
                              }`}
                            >
                              {p.name}
                            ...
                            <td
                              className={`py-2 px-2 md:px-3 hidden sm:table-cell transition-colors truncate max-w-[100px] ${
                                isDarkMode ? "text-slate-300" : "text-gray-700"
                              }`}
                            >
                              {p.company_name || "-"}
                            ...
                            <td
                              className={`py-2 px-2 md:px-3 font-semibold transition-colors truncate ${
                                isDarkMode ? "text-slate-100" : "text-gray-900"
                              }`}
                            >
                  ...
                  <table className="min-w-full text-xs md:text-sm">
                    ...
                    >
                      <tr>
                        ...
                        <th className="py-2 px-2 md:px-3 text-left">Route</th>
                        <th className="py-2 px-2 md:px-3 text-left">Status</th>
                        <th className="py-2 px-2 md:px-3 text-left hidden md:table-cell">
                          Created
                        </th>
                    ...
                    <tbody>
                      {(recent.requests || []).slice(0, 10).map((r, idx) => (
                        ...
                        >
                          ...
                          <td
                            className={`py-2 px-2 md:px-3 transition-colors truncate max-w-[120px] ${
