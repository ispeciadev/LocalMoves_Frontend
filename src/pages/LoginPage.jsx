...
const LoginPage = () => {
  ...
  const handleForgotSubmit = async (e) => {
    ...
    try {
      ...
      // This endpoint should use the password reset template from ManageEmailTemplates
      ...
      toast.error(err.response?.data?.message?.message || "Something went wrong. Try again.");
    } finally {
      setSending(false);
    }
  };
